  ...
  return (
    <>
      ...
      {visibleBooks.length === 0 ? (
        ...
        <div
          ref={gridRef}
          className="px-[55px] sm:px-6 md:px-10 lg:px-16 xl:px-20 mt-[40px] mb-[60px] grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-[50px] sm:gap-[30px]"
        >
