...
export const metadata = {
  title: "Non-Fiction Books - Discover Engaging Non-Fiction at ReadHaven",
  description: "Explore a diverse collection of non-fiction books, including biographies, self-help, history, and more, at ReadHaven.",
};
...
export default function NonFictionPage() {
  return (
    <>
      ...
      <CategoryBookSection category="nonfiction" color="#7A4E2D" />
