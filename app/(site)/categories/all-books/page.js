// app/categories/all-books/page.js

import CategoryBookSection from "@/app/(site)/components/CategoryBookSection";
import Link from "next/link";

export const metadata = {
  title: "All Books - Discover Your Next Favorite Book",
  description: "Explore a wide selection of books across various genres at ReadHaven.",
};
...
export default function AllBooksPage() {
  return (
    <>
      ...
      <CategoryBookSection category="allbooks" color="#7A4E2D" />
      <div className="mt-[170px] px-4 sm:px-6 lg:px-0 flex flex-col lg:flex-row items-center justify-center gap-y-[40px] lg:gap-x-[125px]">
       
        <div className="bg-[#BA68C8] w-full sm:w-[400px] md:w-[500px] lg:w-[621px] h-auto lg:h-[420px] rounded-[15px] shadow-[0_4px_6px_rgba(0,0,0,0.25)] flex flex-col items-center justify-center px-4 sm:px-6 py-8 sm:py-10 lg:py-0">
        ...
        <div className="bg-[#D96666] w-full sm:w-[400px] md:w-[500px] lg:w-[621px] h-auto lg:h-[420px] rounded-[15px] shadow-[0_4px_6px_rgba(0,0,0,0.25)] flex flex-col items-center justify-center px-4 sm:px-6 py-8 sm:py-10 lg:py-0">
          <h1 className="font-playfair font-bold text-[22px] sm:text-[26px] md:text-[32px] lg:text-[40px] leading-[30px] sm:leading-[34px] md:leading-[42px] lg:leading-[48px] text-white text-left w-full max-w-[520px]">
