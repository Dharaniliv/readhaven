...
export const metadata = {
  title: "Thriller Books - Experience the Best Thrillers at ReadHaven",
  description: "Get your heart racing with the most exciting and suspenseful thriller books. Find your next page-turner at ReadHaven.",
};
...
export default function ThrillerPage() {
  return (
    <>
      ...
      <CategoryBookSection category="thriller" color="#BA68C8" />
