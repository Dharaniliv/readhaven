...
import {
  getFictionBooksFromDB,
  storeFictionBooksInDB,
} from "@/app/lib/db/fiction";

export async function GET() {
  try {
    const dbBooks = await getFictionBooksFromDB();
    ...
    const booksData = await fetchBooksByCategory("Fiction", 80);
    ...
    await storeFictionBooksInDB(processedBooks);
