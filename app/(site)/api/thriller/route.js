...
import {
  getThrillerBooksFromDB,
  storeThrillerBooksInDB,
} from "@/app/lib/db/thriller";

export async function GET() {
  try {
    const dbBooks = await getThrillerBooksFromDB();
    ...
    const booksData = await fetchBooksByCategory("Mystery Thriller", 80);
    ...
    await storeThrillerBooksInDB(processedBooks);
