// app/api/romance/route.js
import { NextResponse } from "next/server";
import { fetchBooksByCategory } from "@/app/lib/api/googleBooks";
import {
  getRomanceBooksFromDB,
  storeRomanceBooksInDB,
} from "@/app/lib/db/romance";

export async function GET() {
  try {
    const dbBooks = await getRomanceBooksFromDB();
    ...
    const booksData = await fetchBooksByCategory("Romance", 80);
    ...
    await storeRomanceBooksInDB(processedBooks);
